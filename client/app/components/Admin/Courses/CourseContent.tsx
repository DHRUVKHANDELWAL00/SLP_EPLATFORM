...
import { AiFillAlipayCircle, AiOutlineDelete, AiOutlinePlusCircle } from 'react-icons/ai';
            ...
            <div className={`w-full bg-[#cdc8c817] p-4 ${showSectionInput ? "mt-10":"mb-0"}`}>
              ...
              <div className="flex w-full items-center justify-between my-0">
                ...
                <div className='flex items-center'>
                  ...
                  />
                  <MdOutlineKeyboardArrowDown fontSize="large" className="dark:text-white text-black" style={{transform:isCollapsed[index] ? "rotate(180deg)":"rotate(0deg)"}} onClick={()=>handleCollapseToggle(index)}/>
                </div>
              </div>
              {
                !isCollapsed[index] && (
                  ...
                  <div className="my-3">
                    ...
                    <input type="text" className={styles.input} value={item.title} onChange={(e)=>{
                      const updatedData=[...courseContentData];
                  ...
                  <div className="mb-3">
                    ...
                    <input type="text" placeholder='www.video.com' className={styles.input} value={item.videoUrl} onChange={(e)=>{
                      const updatedData=[...courseContentData];
                  ...
                  </div>
                  {
                    ...
                    <input type="text" placeholder='Source code' className={styles.input} value={link.title} onChange={(e)=>{
                      const updatedData=[...courseContentData];
                      updatedData[index].links[linkIndex].title = e.target.value;
                      setCourseContentData(updatedData);
                    }}/>
                     <input type="url" placeholder='Source code url' className={`${styles.input} mt-6`} value={link.url} onChange={(e)=>{
                      const updatedData=[...courseContentData];
              ...
              {index===courseContentData.length-1 && (
                <div>
                                  <p className='flex items-center font-Poppins font-[18px] dark:text-white text-black cursor-pointer' onClick={(e:any)=>newContentHandler(item)}>
                                  <AiOutlinePlusCircle className='cursor-pointer dark:text-white text-black mr-2'/> Add New Content
                                   </p>
