...
const Hero:FC<Props> = (props) => {
  return (
    <div className="w-full 1000px:flex-col items-center flex-wrap dark:bg-slate-800 bg-white">
        <div className="absolute w-[1/2] 1000px:w-[40%] top-[100px] 1000px:top-[unset] 1500px:h-[700px] 1500px:w-[700px] 1100px:h-[600px] 1100px:w-[600px] h-[50vh] w-[50vh] hero_animation rounded-full dark:bg-slate-800 bg-white">
        ...
        <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[200px] w-[1/2]">
                ...
                <div className="1500px:w-[55%] 1100px:w-[78%] w-[90%] h-[50px] bg-transparent relative">
                    <input type="search" placeholder="Search Courses..." className="bg-transparent border dark:border-none  rounded-r-[15px] dark:bg-[#575757] dark:placeholder:text-[#ffffffdd] rounded-[5px[ p-2 w-full h-full outline-none"/>
                ...
                <div className="1500px:w-[55%] 1100px:w-[78%] flex items-center">
                    <Image src={require("../../../public/images.png")} alt="" className="rounded-full h-10 w-10"/>
                    <Image src={require("../../../public/images.png")} alt="" className="rounded-full ml-[-20px] h-10 w-10"/>
                    <Image src={require("../../../public/images.png")} alt="" className="rounded-full ml-[-20px] h-10 w-10"/>
